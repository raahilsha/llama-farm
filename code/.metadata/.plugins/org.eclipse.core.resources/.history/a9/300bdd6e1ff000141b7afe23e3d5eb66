...
public class Parameters
{
	...
	public static String experiment_notes = "All values started at 0.5";
	...
	public static double world_hazrate = 0.3; // Probability of a spot on the world being dangerous = hazrate - obsrate
	...
	public static double energy_init = 500; // Initial energy
