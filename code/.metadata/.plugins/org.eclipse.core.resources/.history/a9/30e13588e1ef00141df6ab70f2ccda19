...
public class Parameters
{
	...
	public static String experiment_notes = "All values started at 0.8";
	...
	// Genetics Settings
	public static double mutation_rate = 0.1; // Rate of mutation
	public static int genome_length = 100; // Length of each gene
	
	// Initial Genome Settings
	public static double hunger_init = 0.8; // Initial hunger probability
	public static double lazy_init = 0.8; // Initial laziness probability
	public static double violent_init = 0.8; // Initial violence probability
	public static double meta_init = 0.8; // Initial metabolism probability
	public static double style_init = 0.8; // Initial style probability
